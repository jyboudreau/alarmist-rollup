import { combine, flatten, forEach, fromPromise, map, merge, pipe, scan, share } from 'callbag-basics'
import { debounce } from 'callbag-debounce'
import { default as fromNodeEvent } from 'callbag-from-events'
import { default as distinctUntilChanged } from 'callbag-distinct-until-changed'
import of from 'callbag-of'
import { watch as watchFile } from 'chokidar'
import { curry } from 'lodash/fp'
import tap from 'callbag-tap'
import { resolve, dirname, relative, isAbsolute } from 'path'
import { watch as createRollupWatcher, VERSION as ROLLUP_VERSION } from 'rollup'
import { default as loadRollup } from 'rollup/dist/loadConfigFile'
import yargs from 'yargs'
import { createJob } from 'alarmist'
